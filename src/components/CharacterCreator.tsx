...
// [แก้ไขตรงนี้] เติมคำว่า type เข้าไปหน้าปีกกาครับ
...
export const CharacterSvg: React.FC<Props> = ({ appearance, theme = 'default', className, type }) => {
  // สร้าง ID สำหรับ Filter เพื่อไม่ให้ชนกัน
  ...
  // ถ้ามีการส่ง type มา (ใช้ในหน้าเลือกตัวละคร) ให้แปลงเป็น Theme จำลอง
  ...
  // หมวก/อุปกรณ์เสริมตาม Type (ถ้ามี)
